...
def train(epochs, model, train_loader, val_loader, criterion, optimizer):
    ...
    for epoch in range(epochs):
        ...
        if epoch % 3 == 0:
            ...
            torch.save(model.state_dict(), r"./checkpoints/{}_state_dict_{}.pth".format(config["backbone"], epoch))
    ...
    torch.save(model.state_dict(), r"./checkpoint/{}_state_dict.pth".format(config["backbone"]))
